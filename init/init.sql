...
CREATE TABLE EMPLOYEE_WAREHOUSE_ASSIGNMENTS (
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT FK_EMPLOYEE_ASSIGNMENTS_EMPLOYEE FOREIGN KEY (employee_id) REFERENCES EMPLOYEES (id) ON DELETE SET DEFAULT,
...
CREATE TABLE ROLES_EMPLOYEES (
     ...
     CONSTRAINT FK_ROLES_EMPLOYEES_ROLE FOREIGN KEY (roles_id) REFERENCES ROLES (id) ON DELETE RESTRICT,
     CONSTRAINT FK_ROLES_EMPLOYEES_EMPLOYEE FOREIGN KEY (employees_id) REFERENCES EMPLOYEES (id) ON DELETE RESTRICT
);
...
CREATE TABLE PERMISSIONS_ROLES (
    ...
    CONSTRAINT FK_PERMISSIONS_ROLES_PERMISSION FOREIGN KEY (permissions_id) REFERENCES PERMISSIONS (id) ON DELETE RESTRICT,
    CONSTRAINT FK_PERMISSIONS_ROLES_ROLE FOREIGN KEY (roles_id) REFERENCES ROLES (id) ON DELETE RESTRICT
);
