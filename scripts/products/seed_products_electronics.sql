...
FROM stg_products s ON CONFLICT DO NOTHING;
...
FROM PRODUCTS p
         ...
         JOIN cat_ancestors ca ON ca.leaf_id = lc.id ON CONFLICT DO NOTHING;
...
SELECT 'PRODUCTS' AS tbl, COUNT(*) AS rows
FROM PRODUCTS
UNION ALL
